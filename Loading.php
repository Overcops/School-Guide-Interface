                    ...
                    <section>
                        <div>
                            ...
                            <form action="/Loading.php" method="POST">
                                <span class="form form-1">Username</span><input type="text" name="username" placeholder="[Username] ">
                                <span class="form form-2">Password</span><input type="text" name="mdp" placeholder="[Password]">
                            </form>
                            <div class="space">
